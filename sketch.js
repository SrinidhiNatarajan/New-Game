...
function preload(){
  ...
  ghost3 = loadImage("./assets/Gpink_left.jpg")
...
function setup(){
  ...
  ghostblue1 = createSprite(200,300,25,25)
  ...
  ghostred1 = createSprite(200,100,25,25)
  ...
  ghostpink1 = createSprite(500,100,25,25)
  ...
  ghostyellow1 = createSprite(750,100,25,25)
